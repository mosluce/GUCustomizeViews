#
#  Be sure to run `pod spec lint GUCustomizeViews.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "mosluce"
  # s.authors            = { "mosluce" => "mosluce@gmail.com" }
  # s.social_media_url   = "http://twitter.com/mosluce"
